import type { DataSourceIconId, ModelProviderIconId } from '../../../shared/icons/dify-provider-icons'

export type { DataSourceIconId, ModelProviderIconId } from '../../../shared/icons/dify-provider-icons'
