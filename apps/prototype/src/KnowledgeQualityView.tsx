...
import { ActionToast, EmptyPanel, Panel } from './knowledge-2-panel'

export function KnowledgeQualityView({ item }: { item: Knowledge2Item }) {
  ...
  const [selectedTrace, setSelectedTrace] = useState<KnowledgeTrace | null>(null)
  ...
  const createBadCaseFromTrace = (trace: KnowledgeTrace) => {
